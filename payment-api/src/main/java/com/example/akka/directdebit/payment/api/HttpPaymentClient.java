...
public record HttpPaymentClient(HttpClient httpClient) implements PaymentClient{
    private static final Logger logger = LoggerFactory.getLogger(HttpPaymentClient.class);

    public HttpPaymentClient(HttpClientProvider httpClientProvider){
...
//        return httpClient.POST("/payment/import")
